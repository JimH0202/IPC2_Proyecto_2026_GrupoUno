...
public class DataController : ControllerBase
{
    ...
    public IActionResult GetMatrixData()
    {
        try
        {
            var matrixData = MockDataService.GetMatrixViewModel();
    ...
    public IActionResult GetMemoryReport()
    {
        try
        {
            var reportData = MockDataService.GetReportViewModel("MemoryLayout");
    ...
    public IActionResult GetLiveSimulationData()
    {
        try
        {
            var liveData = MockDataService.GetSimulationViewModel();
